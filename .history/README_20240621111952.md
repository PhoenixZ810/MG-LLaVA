...
### Train
MG-LLaVA follows a two-stage training process
The entire training process takes approximately 23 hours when using the Vicuna7B~\cite{chiang2023vicuna} model using 8×A100 GPUs.
