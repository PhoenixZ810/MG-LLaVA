...
pretrained_pth = 'work_dirs/ram_owl_pretrain_coco80/iter_2181.pth'
# Data
...
llava_dataset = dict(
    ...
    # box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/llava_v1_5_mix665k_only_box.json',
    box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/llava_v1_5_mix665k_only_box_coco.json',
    data_path=data_path,
...
val_dataset = [
    dict(
        ...
        proxy_eval_dataset=dict(type=BoxLLaVAProxyEvalDataset,
                                box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/eval_box_coco/MME_only_bbox.json'),
...
test_dataset = [
    dict(
        ...
        proxy_eval_dataset=dict(type=BoxLLaVAProxyEvalDataset,
                                box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/eval_box_coco/MMBench_DEV_EN_only_bbox.json'),
    ...
    dict(
        type=MultipleChoiceDataset,
        proxy_eval_dataset=dict(type=BoxLLaVAProxyEvalDataset,
                                box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/eval_box_coco/MMBench_TEST_EN_only_bbox.json'),
    ...
    dict(
        type=MultipleChoiceDataset,
        proxy_eval_dataset=dict(type=BoxLLaVAProxyEvalDataset,
                                box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/eval_box_coco/SEEDBench_IMG_only_bbox.json'),
    ...
    dict(
        type=MultipleChoiceDataset,
        proxy_eval_dataset=dict(type=BoxLLaVAProxyEvalDataset,
                                box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/eval_box_coco/ScienceQA_VAL_only_bbox.json'),
    ...
    dict(
        type=MultipleChoiceDataset,
        proxy_eval_dataset=dict(type=BoxLLaVAProxyEvalDataset,
                                box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/eval_box_coco/ScienceQA_TEST_only_bbox.json'),
    ...
    dict(
        type=MultipleChoiceDataset,
        proxy_eval_dataset=dict(type=BoxLLaVAProxyEvalDataset,
                                box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/eval_box_coco/MMMU_DEV_VAL_only_bbox.json'),
    ...
    dict(
        type=MultipleChoiceDataset,
        proxy_eval_dataset=dict(type=BoxLLaVAProxyEvalDataset,
                                box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/eval_box_coco/AI2D_TEST_only_bbox.json'),
    ...
    dict(
        type=TextVQADataset,
        proxy_eval_dataset=dict(type=BoxLLaVAProxyEvalDataset,
                                box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/eval_box_coco/llava_textvqa_val_v051_ocr_only_bbox.json'),
    ...
    dict(
        ...
        proxy_eval_dataset=dict(type=BoxLLaVAProxyEvalDataset,
                                box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/eval_box_coco/HallusionBench_only_bbox.json'),
    ...
    dict(
        type=POPEDataset,
        proxy_eval_dataset=dict(type=BoxLLaVAProxyEvalDataset,
                                box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/eval_box_coco/pope/coco_pope_adversarial_only_bbox.json'),
        data_file=[
