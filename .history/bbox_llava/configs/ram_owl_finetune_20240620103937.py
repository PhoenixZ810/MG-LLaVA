...
from bbox_llava.evaluation import BoxLLaVAProxyEvalDataset
...
from bbox_llava.module import BoxLLaVADataset
#######################################################################
#                          PART 1  Settings                           #
#######################################################################
# Model
...
pretrained_pth = 'work_dirs/raw_owl_pretrain/iter_2181.pth'
...
train_dataloader = dict(
    ...
    collate_fn=dict(type=mm_collate_fn, extra_collate_keys=['gt_boxes', 'gt_labels']))
...
val_dataset = [
    dict(
        type=MMEDataset,
        proxy_eval_dataset=dict(type=BoxLLaVAProxyEvalDataset,
...
val_dataloader = dict(
    ...
    collate_fn=dict(type=mm_collate_fn, extra_collate_keys=['gt_boxes', 'gt_labels', 'img_id']))
val_evaluator = dict()
