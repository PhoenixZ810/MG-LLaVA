...
from bbox_llava.evaluation import P2GLLaVAProxyEvalDataset
...
from bbox_llava.module import P2GLLaVADataset
...
# test_dataset = [
    ...
    #     proxy_eval_dataset=dict(
    #         type=P2GLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/llava_textvqa_val_v051_ocr_only_bbox.json',
    #         tokenizer=tokenizer,
    #     ),
    ...
    #     proxy_eval_dataset=dict(
    #         type=P2GLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/pope_box/coco_pope_adversarial_only_bbox.json',
    #         tokenizer=tokenizer,
    #     ),
    #     data_file=[
