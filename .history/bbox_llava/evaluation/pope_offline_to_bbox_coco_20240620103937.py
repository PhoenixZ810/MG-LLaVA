...
save_json_path = [
    'data/eval_box_coco/pope/coco_pope_adversarial_only_bbox.json',
    'data/eval_box_coco/pope/coco_pope_popular_only_bbox.json',
    'data/eval_box_coco/pope/coco_pope_random_only_bbox.json',
]
