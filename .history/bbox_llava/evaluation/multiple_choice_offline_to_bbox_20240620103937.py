...
data_name = ['MMBench_DEV_EN.tsv', 'MMBench_TEST_EN.tsv', 'SEEDBench_IMG.tsv', 'ScienceQA_VAL.tsv', 'ScienceQA_TEST.tsv', 'MMMU_DEV_VAL.tsv', 'AI2D_TEST.tsv', 'HallusionBench.tsv', 'MME.tsv', 'MMStar.tsv']

mme_image_folder = '/mnt/petrelfs/share_data/duanhaodong/data/mme/MME_Benchmark_release'
save_path = 'data/eval_box'
...
if __name__ == '__main__':
    ...
    for d in data_name:
        ...
        for i in tqdm(per_rank_ids, desc=f'Rank {rank}'):
            ...
            text = texts[index1]
            boxes, scores, labels = results[index1]["boxes"], results[index1]["scores"], results[index1]["labels"]
