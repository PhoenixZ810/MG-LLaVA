...
data_path = '/mnt/petrelfs/share_data/zhaoxiangyu/pretrain_blip_allava_1266k.json'
offline_processed_text_folder = 'data/text_cache/yi_pretrain_more'
...
llava_dataset = dict(
    ...
    box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/pretrain_blip_allava_126k_only_box.json',
