...
from xtuner.engine.runner import TrainLoop, ValLoop, TestLoop1
...
#######################################################################
# Model
# llm_name_or_path = '/mnt/hwfile/llmeval/opencompass/checkpoints/llm/hf_hub/models--01-ai--Yi-1.5-34B-Chat/snapshots/fa695ee438bfcd0ec2b378fa1c7e0dea1b40393e/'
llm_name_or_path = 'work_dirs/fuse_more_yi34B_clip_L_14_336_sft_padding/iter_10805_llm_hf.pth'
...
# pretrained_pth = None
pretrained_pth = 'work_dirs/fuse_more_yi34B_clip_L_14_336_sft_padding/iter_10805_nollm.pth'
...
test_dataset = [
    ...
    #     proxy_eval_dataset=dict(
    #         type=ObjectLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/tallyqa/tallyqa_38k_only_box.json',
    #         image_size_aux=image_size_aux,
    #         limit_num=limit_num,
    #     ),
    #     data_file='/mnt/hwfile/mm_dev/zhaoxiangyu/tallyqa/test.json',
...
test_cfg = dict(type=TestLoop1, select_metric='first')
