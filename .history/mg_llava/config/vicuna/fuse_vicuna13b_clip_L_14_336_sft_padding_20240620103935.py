...
from xtuner.engine.runner import TrainLoop, ValLoop, TestLoop, TestLoop1, TestLoop2
from mmengine.dataset import DefaultSampler

from mg_llava.evaluation import ObjectLLaVAProxyEvalDataset, GQADataset, VQAv2Dataset
...
#######################################################################
# Model
# llm_name_or_path = '/mnt/hwfile/llmeval/opencompass/checkpoints/llm/hf_hub/models--lmsys--vicuna-13b-v1.5/snapshots/3deb0106f72a3a433f0c6ea0cb978bdf14bcd3a6'
llm_name_or_path = 'work_dirs/fuse_vicuna13b_clip_L_14_336_sft_padding/iter_21000_llm_hf.pth'
...
# pretrained_pth = 'work_dirs/fuse_vicuna13b_clip_L_14_336_pretrain_padding/iter_4947.pth'
pretrained_pth = 'work_dirs/fuse_vicuna13b_clip_L_14_336_sft_padding/iter_21000_nollm.pth'

# Data
box_json_path = (
    '/mnt/hwfile/mm_dev/zhaoxiangyu/instruct_llava_allava_doc_dvqa_share_ai2d_1383k_only_box.json'
)
data_root = '/mnt/petrelfs/share_data/huanghaian/llava_data/'
data_path = '/mnt/hwfile/mm_dev/zhaoxiangyu/instruct_llava_allava_doc_dvqa_share_ai2d_1383k.json'
# data_path = 'debug/llava_v1_5_mix5k.json'
offline_processed_text_folder = 'data/text_cache/large_vicuna_sft_1383k'
# offline_processed_text_folder = 'data/text_cache/vicuna_sft_5000'
...
val_dataset = [
    dict(
        ...
        proxy_eval_dataset=dict(
            ...
            box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/MME_only_bbox.json',
            image_size_aux=image_size_aux,
            limit_num=limit_num,
        ),
...
#         proxy_eval_dataset=dict(
#             type=ObjectLLaVAProxyEvalDataset,
#             box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/MMBench_DEV_EN_only_bbox.json',
#             image_size_aux=image_size_aux,
#             limit_num=limit_num,
#         ),
...
#         proxy_eval_dataset=dict(
#             type=ObjectLLaVAProxyEvalDataset,
#             box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/MMBench_TEST_EN_only_bbox.json',
#             image_size_aux=image_size_aux,
#             limit_num=limit_num,
#         ),
...
#         proxy_eval_dataset=dict(
#             type=ObjectLLaVAProxyEvalDataset,
#             box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/SEEDBench_IMG_only_bbox.json',
#             image_size_aux=image_size_aux,
#             limit_num=limit_num,
#         ),
...
#         proxy_eval_dataset=dict(
#             type=ObjectLLaVAProxyEvalDataset,
#             box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/ScienceQA_VAL_only_bbox.json',
#             image_size_aux=image_size_aux,
#             limit_num=limit_num,
#         ),
...
#         proxy_eval_dataset=dict(
#             type=ObjectLLaVAProxyEvalDataset,
#             box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/ScienceQA_TEST_only_bbox.json',
#             image_size_aux=image_size_aux,
#             limit_num=limit_num,
#         ),
...
#         proxy_eval_dataset=dict(
#             type=ObjectLLaVAProxyEvalDataset,
#             box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/MMMU_DEV_VAL_only_bbox.json',
#             image_size_aux=image_size_aux,
#             limit_num=limit_num,
#         ),
...
#         proxy_eval_dataset=dict(
#             type=ObjectLLaVAProxyEvalDataset,
#             box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/AI2D_TEST_only_bbox.json',
#             image_size_aux=image_size_aux,
#             limit_num=limit_num,
#         ),
...
#         proxy_eval_dataset=dict(
#             type=ObjectLLaVAProxyEvalDataset,
#             box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/llava_textvqa_val_v051_ocr_only_bbox.json',
#             image_size_aux=image_size_aux,
#             limit_num=limit_num,
#         ),
...
#         proxy_eval_dataset=dict(
#             type=ObjectLLaVAProxyEvalDataset,
#             box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/DocVQA_VAL_only_bbox.json',
#             image_size_aux=image_size_aux,
#             limit_num=limit_num,
#         ),
#         data_file='/mnt/petrelfs/share_data/huanghaian/LMUData/DocVQA_VAL.tsv',
#         prompt_template=prompt_template,
#         tokenizer=tokenizer,
#         image_processor=image_processor,
#         pad_image_to_square=True,
...
#     ),
    ...
    #     proxy_eval_dataset=dict(
    #         type=ObjectLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/HallusionBench_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #         limit_num=limit_num,
    #     ),
    ...
    #     proxy_eval_dataset=dict(
    #         type=ObjectLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/pope/coco_pope_adversarial_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #         limit_num=limit_num,
    #     ),
    #     data_file=[
    ...
    #     proxy_eval_dataset=dict(
    #         type=ObjectLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/LUMDdata_box/MMStar_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #         limit_num=limit_num,
    #     ),
    #     data_file='/mnt/hwfile/mm_dev/zhaoxiangyu/datasets--Lin-Chen--MMStar/snapshots/mmstar/MMStar.tsv',
    #     prompt_template=PROMPT_TEMPLATE.vicuna,
    #     tokenizer=tokenizer,
    #     image_processor=image_processor,
    #     pad_image_to_square=pad_image_to_square,
    ...
    #     proxy_eval_dataset=dict(
    #         type=ObjectLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/gqa_llava_eval/gqa_box.json',
    #         image_size_aux=image_size_aux,
    #         limit_num=limit_num,
    #     ),
    #     question_file='/mnt/hwfile/mm_dev/zhaoxiangyu/gqa_llava_eval/llava_gqa_testdev_balanced.jsonl',
    #     answer_file='llava_gqa_testdev_balanced_merge.jsonl',
    #     prediction_file='testdev_balanced_predictions.json',
    #     test_question_file='/mnt/hwfile/mm_dev/zhaoxiangyu/gqa_llava_eval/testdev_balanced_questions.json',
    ...
    dict(
        ...
        proxy_eval_dataset=dict(
            type=ObjectLLaVAProxyEvalDataset,
            box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/vqav2_llava_eval/vqav2_box.json',
            image_size_aux=image_size_aux,
        ),
        question_file='/mnt/hwfile/mm_dev/zhaoxiangyu/vqav2_llava_eval/llava_vqav2_mscoco_test-dev2015.jsonl',
        answer_file='llava_vqav2_testdev_balanced_merge.jsonl',
        test_file='/mnt/hwfile/mm_dev/zhaoxiangyu/vqav2_llava_eval/llava_vqav2_mscoco_test2015.jsonl',
        prediction_file='vqav2_testdev_balanced_predictions.json',
        image_folder='/mnt/hwfile/mm_dev/zhaoxiangyu/vqav2_test2015',
        prompt_template=PROMPT_TEMPLATE.vicuna,
        tokenizer=tokenizer,
        image_processor=image_processor,
        pad_image_to_square=pad_image_to_square,
