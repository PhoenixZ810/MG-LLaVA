...
from object_llava.module import MGLLaVADataset, OpenCLIPVisionTower
from object_llava.evaluation import ObjectLLaVAProxyEvalDataset
from mg_llava.module import MultiFuseObjectLLaVAModel
...
#######################################################################
# Model
# llm_name_or_path = '/mnt/petrelfs/share_data/basemodel/checkpoints/llm/hf_hub/models--lmsys--vicuna-13b-v1.5/snapshots/3deb0106f72a3a433f0c6ea0cb978bdf14bcd3a6'
...
#         proxy_eval_dataset=dict(
#             type=ObjectLLaVAProxyEvalDataset,
#             box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/LUMDdata_box/DocVQA_VAL_only_bbox.json',
#             image_size_aux=image_size_aux,
#             limit_num=limit_num,
#         ),
