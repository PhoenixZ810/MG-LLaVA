...
from object_llava.evaluation import ObjectLLaVAProxyEvalDataset, ChatObjectLLaVAProxyEvalDataset
from mg_llava.module import MultiFuseObjectLLaVAModel, MGLLaVADataset, OpenCLIPVisionTower, ObjectLLaVAProxyEvalDataset, ObjectLLaVAProxyEvalDataset
...
test_dataset = [
    ...
    dict(
        type=TallyQADataset,
        proxy_eval_dataset=dict(
            type=ChatObjectLLaVAProxyEvalDataset,
            box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/tallyqa/tallyqa_38k_only_box.json',
            image_size_aux=image_size_aux,
            limit_num=limit_num,
        ),
