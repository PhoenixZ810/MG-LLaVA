...
from xtuner.engine.runner import TrainLoop, ValLoop, TestLoop, TestLoop2
...
pretrained_pth = 'work_dirs/fuse_phi3_clip_L_14_336_pretrain_padding/iter_2181.pth'
...
offline_processed_text_folder = 'data/text_cache/llava_phi3_sft_all'
...
test_cfg = dict(type=TestLoop2, select_metric='first')
