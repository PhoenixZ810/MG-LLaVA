...
Then download [COCO], [GQA], [OCR-VQA], [TextVQA], [VG] following LLaVA-1.5. The Web-Celebrity, Web-Landmark, WikiArt],  Share-TextVQA can be found in [ShareGPT-4V](https://drive.google.com/drive/folders/1tCUQ-sq6vdshZVkF0ZeF3K4eztkXJgax). [AI2D], [DocVQA], [DVQA],
