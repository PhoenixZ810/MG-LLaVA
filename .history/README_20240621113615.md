...
The training process is similar to the original XTuner. Before training, you should check the [configs]() and modify the following vc to your own settings. You can also modify the [configs]() to train the model with your own settings.
