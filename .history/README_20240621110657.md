...
### Train
MG-LLaVA employed several LLMs ranged from 3.8B to 34B, including Vicuna1.5-7B, Vicuna1.5Phi-3, GPT-4, and GPT-5. The training process is similar to the original XTuner. For example, to train the GPT-3 model with the QLoRA task, you can use the following command:
