...
box_json_path = '/mnt/hwfile/mm_dev/zhaoxiangyu/pretrain_valley_llava_126k_only_box.json'
data_path = '/mnt/hwfile/mm_dev/zhaoxiangyu/valley_llavaimage_fixed.json'
...
sft_dataset = dict(
    ...
    data_path='/mnt/hwfile/mm_dev/zhaoxiangyu/allava_vflan/ALLaVA-Instruct-VFLAN-4V-fixed.json',
...
setup_seed(2024)
cfg = Config.fromfile('mg_llava/config/vicuna/fuse_more_vicuna7b_clip_L_14_336_sft_padding.py')
...
#     test_split = '/mnt/hwfile/mm_dev/zhaoxiangyu/vqav2_llava_eval/llava_vqav2_mscoco_test2015.jsonl'
...
# evaluate()
# --------------------------------------------------------------------------------------------
# with open('/mnt/hwfile/mm_dev/zhaoxiangyu/vqav2_llava_eval/vqav2_box.json', 'r') as f:
#     j = json.load(f)
#     json_data = {item['id']: item for item in j}
# data = json_data[436166001]
# with open('/mnt/hwfile/mm_dev/zhaoxiangyu/llava_v1_5_mix665k_only_box.json', 'r') as f:
#     j = json.load(f)
#     json_data = {item['id']: item for item in j}
# data = json_data[436166001]
# bboxes = data['boxes']
...
# ---------------------------------------------------------------------------------------
# from mg_llava.module.instruct_blip import InstructBLIPQFormerTokenizer
# q_tokenizer = InstructBLIPQFormerTokenizer(
#     '/mnt/hwfile/mm_dev/zhaoxiangyu/models--Salesforce--instructblip-vicuna-7b/snapshots/52ba0cb2c44d96b2fcceed4e84141dc40d2b6a92'
# )
