...
#     --kill-on-bad-exit=1 \
#     python xtuner/tools/test.py \
#     mg_llava/config/vicuna/fuse_vicuna13b_clip_L_14_336_sft_padding.py \
...
#     --cpus-per-task=${CPUS_PER_TASK} \
#     --kill-on-bad-exit=1 \
#     python mg_llava/module/test_34B/special_test.py \
#     mg_llava/config/vicuna/fuse_vicuna13b_clip_L_14_336_sft_padding.py \
...
srun -p llmit \
    ...
    --kill-on-bad-exit=1 \
    python xtuner/tools/test.py \
    mg_llava/config/vicuna/fuse_vicuna7b_clip_L_14_336_sft_padding.py \
...
#     --gres=gpu:1 \
#     python xtuner/tools/test.py \
#     mg_llava/config/phi3/fuse_phi3_clip_L_14_336_sft_padding.py \
