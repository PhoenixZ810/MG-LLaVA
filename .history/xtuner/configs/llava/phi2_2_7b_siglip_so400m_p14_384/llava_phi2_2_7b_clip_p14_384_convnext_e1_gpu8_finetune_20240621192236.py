...
from xtuner.dataset import MiniGeminiProxyEvalDataset
...
pretrained_pth = 'work_dirs/llava_phi2_2_7b_clip_p14_384_convnext_e1_gpu8_pretrain/iter_2181.pth'
...
llava_dataset = dict(
    ...
    image_size_aux=image_size_aux,  # siglip 864, clip 768
...
test_dataset = [
    ...
    dict(
        type=GQADataset,
        proxy_eval_dataset=dict(type=MiniGeminiProxyEvalDataset, image_size_aux=image_size_aux),
        data_file='/mnt/hwfile/mm_dev/zhaoxiangyu/gqa_llava_eval/llava_gqa_testdev_balanced.jsonl',
        ann_file='/mnt/hwfile/mm_dev/zhaoxiangyu/gqa_llava_eval/testdev_balanced_questions.json',
    ...
    #     type=VQAv2Dataset,
    #     proxy_eval_dataset = dict(type=MiniGeminiProxyEvalDataset, image_size_aux=image_size_aux),
    #     data_file='/mnt/hwfile/mm_dev/zhaoxiangyu/vqav2_llava_eval/llava_vqav2_mscoco_test-dev2015.jsonl',
...
val_dataloader = dict(
    ...
    collate_fn=dict(type=mm_collate_fn, extra_collate_keys=['img_id','pixel_values_aux']))
val_evaluator = dict()
