...
The training process is similar to the original XTuner. , you should check the configs and modify the [] to your own settings.You can modify the [configs]() to train the model with your own settings.
