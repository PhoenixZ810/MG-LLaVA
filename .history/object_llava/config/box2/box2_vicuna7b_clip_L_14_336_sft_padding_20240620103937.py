...
from object_llava.module import BoxObjectLLaVAModel, MGLLaVADataset, OpenCLIPVisionTower
...
pretrained_pth = 'work_dirs/box2_vicuna7b_clip_L_14_336_pretrain_padding/iter_2181.pth'

# Data
box_json_path = '/mnt/hwfile/mm_dev/zhaoxiangyu/llava_v1_5_mix665k_only_box.json'
...
image_folder = '/mnt/hwfile/xtuner/linzhihao/dataset/llava_data/llava_images/'
