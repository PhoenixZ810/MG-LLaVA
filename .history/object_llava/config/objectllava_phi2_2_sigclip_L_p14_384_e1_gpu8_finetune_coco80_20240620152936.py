...
val_dataset = [
    dict(
        ...
        proxy_eval_dataset=dict(
            ...
            box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/eval_box_coco/MME_only_bbox.json',
            image_size_aux=image_size_aux,
        ),
...
test_dataset = [
    ...
    #     proxy_eval_dataset=dict(
    #         type=MGLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/eval_box_coco/MMBench_DEV_EN_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #     ),
    ...
    #     proxy_eval_dataset=dict(
    #         type=MGLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/eval_box_coco/MMBench_TEST_EN_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #     ),
    ...
    #     proxy_eval_dataset=dict(
    #         type=MGLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/eval_box_coco/SEEDBench_IMG_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #     ),
    ...
    #     proxy_eval_dataset=dict(
    #         type=MGLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/eval_box_coco/ScienceQA_VAL_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #     ),
    ...
    #     proxy_eval_dataset=dict(
    #         type=MGLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/eval_box_coco/ScienceQA_TEST_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #     ),
    ...
    #     proxy_eval_dataset=dict(
    #         type=MGLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/eval_box_coco/MMMU_DEV_VAL_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #     ),
    ...
    #     proxy_eval_dataset=dict(
    #         type=MGLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/eval_box_coco/AI2D_TEST_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #     ),
    ...
    #     proxy_eval_dataset=dict(
    #         type=MGLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/eval_box_coco/llava_textvqa_val_v051_ocr_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #     ),
    ...
    #     proxy_eval_dataset=dict(
    #         type=MGLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/eval_box_coco/HallusionBench_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #     ),
    ...
    #     proxy_eval_dataset=dict(
    #         type=MGLLaVAProxyEvalDataset,
    #         box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/eval_box_coco/pope/coco_pope_adversarial_only_bbox.json',
    #         image_size_aux=image_size_aux,
    #     ),
    #     data_file=[
    ...
    dict(
        ...
        proxy_eval_dataset=dict(
            type=MGLLaVAProxyEvalDataset,
            box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/eval_box_coco/MMStar_only_bbox.json',
            image_size_aux=image_size_aux,
        ),
    ...
    dict(
        ...
        proxy_eval_dataset=dict(
            type=MGLLaVAProxyEvalDataset,
            box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/gqa_llava_eval/gqa_box_coco.json',
            image_size_aux=image_size_aux,
        ),
    ...
    dict(
        ...
        proxy_eval_dataset=dict(
            type=MGLLaVAProxyEvalDataset,
            box_json_path='/mnt/hwfile/mm_dev/zhaoxiangyu/vqav2_llava_eval/vqav2_box_coco.json',
            image_size_aux=image_size_aux,
        ),
