...
from xtuner.dataset import LLaVADataset, ChatLLaVAProxyEvalDataset
...
test_dataset = [
    ...
    dict(
        type=TallyQADataset,
        proxy_eval_dataset=dict(type=ChatLLaVAProxyEvalDataset),
        data_file='debug/appendjson/tally_more.json',
        image_folder='data/mix/vg',
        prompt_template=PROMPT_TEMPLATE.vicuna,
        tokenizer=tokenizer,
        image_processor=image_processor,
