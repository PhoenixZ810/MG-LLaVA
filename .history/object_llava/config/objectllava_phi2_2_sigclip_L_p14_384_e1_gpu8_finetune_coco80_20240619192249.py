...
test_dataset = [
    ...
    dict(
        ...
        proxy_eval_dataset=dict(
            type=ObjectLLaVAProxyEvalDataset,
            box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/eval_box_coco/MMStar_only_bbox.json',
            image_size_aux=image_size_aux,
        ),
    ...
    dict(
        ...
        proxy_eval_dataset=dict(
            type=ObjectLLaVAProxyEvalDataset,
            box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/gqa_llava_eval/gqa_box_coco.json',
            image_size_aux=image_size_aux,
        ),
    ...
    dict(
        ...
        proxy_eval_dataset=dict(
            type=ObjectLLaVAProxyEvalDataset,
            box_json_path='/mnt/petrelfs/share_data/zhaoxiangyu/vqav2_llava_eval/vqav2_box_coco.json',
            image_size_aux=image_size_aux,
        ),
