...
### Train
MG-LLaVA employed several LLMs ranged from 3.8B to 34B, including Phi-3-3.8B, Vicuna1.5-7B, Vicuna1.5-13B, llama3-8B, and Yi1.5-34B. The training process is similar to the original XTuner. For example, to train the G model with the QLoRA task, you can use the following command:
