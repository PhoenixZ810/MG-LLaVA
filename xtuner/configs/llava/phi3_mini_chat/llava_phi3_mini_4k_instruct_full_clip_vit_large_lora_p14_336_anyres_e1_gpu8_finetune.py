...
from xtuner.dataset import AnyResLLaVADataset, AnyResLLaVAProxyEvalDataset
...
llava_dataset = dict(
    ...
    image_grid_pinpoints=image_grid_pinpoints,
    offline_processed_text_folder='./phi3_mini_llava_finetune',
    data_path=data_path,
...
train_dataloader = dict(
    ...
    collate_fn=dict(type=mm_collate_fn, extra_collate_keys=['orig_size'])
)
...
val_dataloader = dict(
    ...
    collate_fn=dict(type=mm_collate_fn, extra_collate_keys=['orig_size', 'img_id']))
val_evaluator = dict()
